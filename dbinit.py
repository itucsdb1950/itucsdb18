...
INIT_STATEMENTS = [
	...
	"CREATE TABLE LOCATION (dep_id INTEGER, dep_name VARCHAR(30), fac_name VARCHAR(30), dean_id INTEGER FOREIGN KEY REFERENCES PERSON(id), stu_delegate INTEGER FOREIGN KEY REFERENCES PERSON(id));"
]
