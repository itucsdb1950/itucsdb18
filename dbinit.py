...
INIT_STATEMENTS = [
	...
	"CREATE TABLE DEPARTMENT (dep_id NUMERIC(4), dep_name VARCHAR(30), fac_name VARCHAR(30), dean_id CHAR(9) REFERENCES PERSON(id), stu_delegate CHAR(9) REFERENCES PERSON(id));"
]
